...
echo "<tr style='padding-top: 0.3em'>
         ...
         <td width='11%' align='center' valign='middle'><a href='excluir.php?id=$id' style='padding-top: 0.3em'><img src='../img/excluir.png' width='16' height='16' border='0' title='EXCLUIR NOTÍCIA' alt='EXCLUIR NOTÍCIA'></a></td>
         </tr>";
}
...
if ($pc > 1) {
echo "<a href='?pagina=$anterior' class='preto'>&#171; Anterior</a> ";
}else{
...
if ($pc < $tp) {
echo "&nbsp;<a href='?pagina=$proximo' class='preto'>Próxima &#187;</a>";
}else{
